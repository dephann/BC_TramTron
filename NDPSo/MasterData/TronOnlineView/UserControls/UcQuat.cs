...
{
    public partial class UcQuat : UserControl
    {
        ...
        {
            InitializeComponent();
            fanImage = ResourceNDP.CanhQQQ; // Thiết lập ảnh cánh quạt
            pictureEdit1.Image = fanImage;

            fanTimer = new Timer();
            fanTimer.Interval = 500; // Thời gian giữa mỗi lần xoay (đơn vị: millisecond)
