...
{
    public partial class UcPrpel : DevExpress.XtraEditors.XtraUserControl
    {
        Bitmap animatedImage = ResourceNDP.t;
        ...
        private void UcPrpel_Load(object sender, EventArgs e)
        {
