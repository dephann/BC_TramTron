...
{
    public partial class UcBtnNoiTron : System.Windows.Forms.UserControl
    {
        private string _caption;
        private bool _isOn;
        private BGColorEnum _bgColor;
        private Bitmap _colorClick = ResourceNDP.ButtonNoiTron_Click;
        private Bitmap _colorNoClick = ResourceNDP.ButtonNoiTron;
            ...
            set
            {
                ...
                switch (this._bgColor)
                {
                    case BGColorEnum.Clik:
                        this.BackgroundImage = ResourceNDP.ButtonNoiTron_Click;
                        this.labelControl1.ForeColor = Color.White;
                        break;
                    case BGColorEnum.NoClick:
                        this.BackgroundImage = ResourceNDP.ButtonNoiTron;
                        this.labelControl1.ForeColor = Color.White;
                        break;
