...
{
    public partial class UcBtnWaiting : UserControl
    {
        ...
        private void UcBtnWaiting_Click(object sender, EventArgs e)
        {
        ...
        private void UcBtnWaiting_MouseDown(object sender, MouseEventArgs e)
        {
            this.BackgroundImage = Color_Click;
        }

        private void UcBtnWaiting_MouseUp(object sender, MouseEventArgs e)
        {
